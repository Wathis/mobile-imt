 ...
 *
 * TODO 1. Appliquer le style conteneurSaisie à l'élément <View> x
 *
 * TODO 2. Appliquer le style texteSaisie à l'élément <TextInput> x
 *
 * TODO 3. Valoriser la propriété `value` de l'élément <TextInput> avec la valeur de `texteSaisie` x
 *
 * TODO 4. Valoriser la propriété `onChangeText` de l'élément <TextInput> avec la valeur de `evtTexteModifie` x
 */
const Saisie = ({texteSaisie, evtTexteModifie}) => {
    return <View style={styles.conteneurSaisie}>
        <TextInput
