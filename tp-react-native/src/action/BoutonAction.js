 ...
 *
 * TODO 1. Modifier le code pour que le bouton soit configurable via son nom. x
 *
 ...
 *
 */
const BoutonAction = ({nom, onPress, isTermine}) => (
    <TouchableHighlight
        underlayColor='#efefef'
        onPress={onPress}
        style={styles.bouton}>
        <Text style={isTermine ? styles.termine : styles.texte}>
            {nom}
        </Text>
    </TouchableHighlight>
)
